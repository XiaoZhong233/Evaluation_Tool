...
parser.add_argument('path', type=str, nargs=2, default=['./val/real','./val/fake'],
...
def main():
    ...
    path = ['./val/fake/r_img_last2000','./val/real/r_img_last2000']
    batchsize = 6
    device = 'cuda'
    dims = 2048
    num_workers = 0

    fid_value = calculate_fid_given_paths(path,batchsize,device,dims,num_workers)
